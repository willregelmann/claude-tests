...
assertions:
  ...
  - CLAUDE.md lists the correct plugin components (commands/run.md, agents/test-runner.md, agents/test-runner-exec.md, skills/write-test/SKILL.md, bin/run-tests.py, bin/eval-reliability.py, plugin.json)
